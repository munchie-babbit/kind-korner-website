...
import market from "../images/market-event.jpeg";
...
export default function Events() {
  ...
  return (
    <div className="mx-20 border border-customDarkGreen rounded-lg mb-10 max-h-80 flex">
      ...
      <div className="w-1/2 overflow-hidden">
        <a href="#">
          <Image src={eventData.image} alt="Close up of a local market booth" />
        </a>
      </div>
    </div>
  );
